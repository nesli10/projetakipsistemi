            ...
            <div class="card mb-4">
                ...
                <div class="table-responsive p-0">
                    ...
                    <thead>
                        ...
                        <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7 ps-2">Ünvanı</th>
                        
                        <th class="text-center text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">Öğrenci Sayısı</th>
                    ...
                    <tbody>
                        ...
                        @php
                            $sayi = \App\Models\Student::where('danisman_id',$item->danisman_id)->count();
                        @endphp
                        <tr>
                            <td>
                            ...
                            <td>
                                <p class="text-xs font-weight-bold mb-0">{{$item->unvan}}</p>
                            </td>
                            <td class="align-middle text-center">
                                <span class="badge badge-sm bg-gradient-success">{{$sayi}}</span>
                            </td>
                            ...
                            <td class="align-middle">
                                <a href="{{url('danisman-ogr-goruntule/'.$item->danisman_id)}}"class="text-primary font-weight-bold text-xs" data-toggle="tooltip" data-original-title="Edit user">
                                Öğrencilerini Görüntüle
                                </a>
                            </td>
                        </tr>
                        @endforeach
