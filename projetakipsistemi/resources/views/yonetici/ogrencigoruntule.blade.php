            ...
            <div class="card mb-4">
                ...
                <div class="table-responsive p-0">
                    ...
                    <thead>
                        ...
                        <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7 ps-2">Danışman Adı</th>
                        <th class="text-center text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">Fakülte/Bölüm/Sınıf</th>
                    ...
                    <tbody>
                        @foreach ($ogrenciler as $item)
                            @php
                                $danismanad = \App\Models\Teacher::where('danisman_id',$item->danisman_id)->value('ad');
                                $dsoyad = \App\Models\Teacher::where('danisman_id',$item->danisman_id)->value('soyad');
                        ...
                        <tr>
                            ...
                            <td >
                                <p class="text-xs font-weight-bold mb-0">{{$danismanad}} {{$dsoyad}}</p>
                                <p class="text-xs text-secondary mb-0">{{$unvan}}</p>
                            </td>
                            <td class="align-middle text-center text-sm">
                                <p class="text-xs font-weight-bold mb-0">{{$fak}}</p>
                                <p class="text-xs font-weight-bold mb-0">{{$bol}}</p>
