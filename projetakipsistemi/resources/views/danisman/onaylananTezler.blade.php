                                ...
                                <table class="table align-items-center mb-0">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a href="../assets/belge/{{$item->pdf}}" download="{{$item->pdf}}">{{$item->ogr_no}}.pdf</a> </br>
                                            </td>
                                            <td>
                                                <a href="../assets/belge/{{$item->word}}" download="{{$item->word}}">{{$item->ogr_no}}.word</a> </br>
                                            </td>
                                            <td>
