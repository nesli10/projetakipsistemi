                                ...
                                <table class="table align-items-center mb-0">
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">Amaç</th>
                                            <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">Yöntem</th>
                                            <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">Anahtar Kelimeler</th>
                                    ...
                                    <tbody>
                                        ...
                                        $projeDurum=\App\Models\State::where('id',$item->durum_id)->value('durum');
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <p class="text-xs font-weight-bold mb-0">{{$item->amac}} </p>
                                            </td>
                                            <td>
                                                <p class="text-xs font-weight-bold mb-0">{{$item->yontem}} </p>
                                            </td>
                                            <td>
                                                <p class="text-xs font-weight-bold mb-0">{{$item->kelime1}}-{{$item->kelime2}}-{{$item->kelime3}}-{{$item->kelime4}}{{$item->kelime5}}</p>
                                            </td>
                                            <td>
                                            ...
                                            <td class="align-middle">
                                                <p class="text-xs font-weight-bold mb-0">{{$projeDurum}} </p>
                                            </td>
                                            @if($item->yorum==NULL)
                                            <td class="align-middle">
                                                <form action="{{url('projeYorumEkle') }}" method="POST">
                                                    @csrf
                                                    <input type="hidden" class="btn bg-gradient-dark btn-md mt-4 mb-4" value="{{$item->danisman_id}}" name="danisman_id"></input>
                                                    <input type="hidden" class="btn bg-gradient-dark btn-md mt-4 mb-4" value="{{$item->id}}" name="id"></input>
                                                    <textarea class="form-control" aria-label="With textarea" name="danismanYorum"></textarea>
                                                    <button type="submit" class="btn bg-gradient-dark btn-sm mt-2 mb-2" name="projeYorumEkle">Ekle</button>
                                                </form>
                                            </td>
                                            @endif
                                            @if($item->yorum!=NULL)
                                            ...
                                            <td class="d-flex justify-content">
                                                @if($item->durum_id==1)
                                                <form action="{{url('projeOnay') }}" method="POST">
                                                    @csrf
                                                    <input type="hidden" class="btn bg-gradient-dark btn-md mt-4 mb-4" value="{{$item->danisman_id}}" name="danisman_id"></input>
                                                    <input type="hidden" class="btn bg-gradient-dark btn-md mt-4 mb-4" value="{{$item->id}}" name="id"></input>
                                                    <button type="submit" class="btn bg-gradient-dark btn-md mt-4 mb-4" name="projeOnay">ONAYLA</button>
                                                </form>
                                                <form action="{{url('projeRed') }}" method="POST">
                                                    @csrf
                                                    <input type="hidden" class="btn bg-gradient-dark btn-md mt-4 mb-4" value="{{$item->danisman_id}}" name="danisman_id"></input>
                                                    <input type="hidden" class="btn bg-gradient-dark btn-md mt-4 mb-4" value="{{$item->id}}" name="id"></input>
                                                    <button type="submit" class="btn bg-gradient-dark btn-md mt-4 mb-4" name="projeRed">REDDET</button>
                                                </form>
                                                @endif
                                            </td>
                                            @endif
