                            ...
                            <div class="table-responsive p-0">
                                <table class="table align-items-center mb-0">
                                    ...
                                    <tbody>
                                        ...
                                        $tezDurum=\App\Models\State::where('id',$item->durum_id)->value('durum');
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a href="../assets/belge/{{$item->pdf}}" download="{{$item->pdf}}">{{$item->ogr_no}}.pdf</a>
                                            </td>
                                            <td>
                                                <a href="../assets/belge/{{$item->word}}" download="{{$item->word}}">{{$item->ogr_no}}.word</a>
                                            </td>
                                            <td>
                                            ...
                                            <td class="align-middle">
                                                <p class="text-xs font-weight-bold mb-0">{{$tezDurum}} </p>
                                            </td>
                                            <td class="d-flex justify-content">
                                                @if($item->durum_id==1)
                                                <form action="{{url('tezOnay') }}" method="POST">
                                                    @csrf
                                                    ...
                                                    <button type="submit" class="btn bg-gradient-dark btn-md mt-4 mb-4" name="tezOnay">ONAYLA</button>
                                                </form>
                                                <form action="{{url('tezRed') }}" method="POST">
                                                    @csrf
                                                    <input type="hidden" class="btn bg-gradient-dark btn-md mt-4 mb-4" value="{{$item->danisman_id}}" name="danisman_id"></input>
                                                    <input type="hidden" class="btn bg-gradient-dark btn-md mt-4 mb-4" value="{{$item->id}}" name="id"> </input>
                                                    <button type="submit" class="btn bg-gradient-dark btn-md mt-4 mb-4" name="tezRed">REDDET</button>
                                                </form>
                                                @endif
                                            </td>
                                            @endif
